...
> **衍生作品声明**：本项目是 [PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets)（作者 zhiyiYo）的 C++ 移植版本。作为衍生作品，本项目遵照原项目许可证以 GPL-3.0 发布。
...
QFluentKit 采用 [GNU 通用公共许可证 v3.0](LICENSE) 授权。
...
- 基于：[PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) — 本项目是 PyQt-Fluent-Widgets 的 C++ 移植/衍生作品。
